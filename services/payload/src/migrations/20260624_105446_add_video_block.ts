...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_pages_blocks_video_fond" AS ENUM('paper', 'beige', 'violet', 'orange', 'magenta', 'vert', 'bleu');
  CREATE TABLE "pages_blocks_video" (
  	...
  	"titre" varchar,
  	"fond" "enum_pages_blocks_video_fond",
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_pages_blocks_video_fond";`)
}
