...
sections:
  - type: "prose"
    ...
    body: |
      Un parcours d'accompagnement corporel, c'est un temps pour vous — à un rythme qui vous convient, dans un lieu sécurisé, avec une intervenante formée. Chaque séance est construite à partir de **ce que vous souhaitez**.

      Ça peut être, selon les jours et les envies :

      - un temps de respiration guidée ;
      - de l'automassage (main, visage, pieds, épaules…) ;
      - de l'éveil corporel doux ;
      - un massage (pieds, main, dos, visage…) ;
      - simplement un temps de présence, d'écoute, sans toucher ;
  ...
  - type: "cta"
    ...
    corps: "Écrivez-nous — même juste pour poser une question. Nous vous répondons."
    cta_primaire:
